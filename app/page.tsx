      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            ...
            <Link href="/iniciar-sesion" className="btn xl magenta">✦  CREAR CUENTA</Link>
          </div>
        ...
        <div className="activity-grid">
          ...
          <div className="activity-card">
            <div className="ac-head">
              ...
              <Link href="/salon-de-la-fama" className="lb-link">VER SALÓN →</Link>
            </div>
      ...
      <section className="home-section">
        ...
        <div className="pricing-grid">
          <div className="price-card">
            ...
            <Link href="/iniciar-sesion" className="btn xl pulse" style={{ width: "100%" }}>EMPEZAR GRATIS →</Link>
